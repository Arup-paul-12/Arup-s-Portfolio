    ...
    <div className="projects-container" id="projects">
        ...
        <div className="projects-grid">
            <div className="project">
                <a href="https://simple-portfulio.netlify.app/" target="_blank" rel="noreferrer"><img src={portfolio} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://tic-tac-gamek.netlify.app/" target="_blank" rel="noreferrer"><img src={game1} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://extraordinary-gingersnap-825dbd.netlify.app/" target="_blank" rel="noreferrer"><img src={passcode} className="zoom" alt="thumbnail" width="100%"/></a>
            ...
            <div className="project">
                <a href="https://amazon-clone-projectt.netlify.app/" target="_blank" rel="noreferrer"><img src={amazone} className="zoom" alt="thumbnail" width="100%"/></a>
